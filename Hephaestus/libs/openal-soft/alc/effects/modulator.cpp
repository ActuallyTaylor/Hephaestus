 ...
 *  modify it under the terms of the GNU libs General Public
 ...
 *  libs General Public License for more details.
 *
 * You should have received a copy of the GNU libs General Public
