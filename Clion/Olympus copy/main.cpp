...
// Include Classes
#include "Hephaestus/Classes/Window/WindowDelegate/WindowDelegate.hpp"
#include "Hephaestus/Classes/Shader/Shader.hpp"
#include "Hephaestus/Classes/Geometry Manager/GeometryManager.hpp"
#include "Hephaestus/Classes/Geometry Manager/Vertex/Vertex.hpp"

#include <glm/glm.hpp>
#include <glm/ext/matrix_transform.hpp>
#include <glm/gtc/type_ptr.hpp>

#include "Hephaestus/Classes/Controls/Controls.hpp"
...
void init() {
    engine.addSprite("First Sprite", "./Images/missing.jpg");
    engine.addSprite("Second Sprite", "./Images/wall.jpg", vec3(300.0f, 300.0f ,15.0f), vec2(100.0f, 100.0f), vec3(100.0f, 0.0f, 30.0f));
}
